...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PD3     ------> USART2_CTS
    */
    GPIO_InitStruct.Pin = XBee_DIN_Pin|XBee_DOUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  */
    ...
    PD9     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = DE2_DIN_Pin|DE2_DOUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PD3     ------> USART2_CTS
    */
    HAL_GPIO_DeInit(GPIOA, XBee_DIN_Pin|XBee_DOUT_Pin);
  ...
  else if(huart->Instance==USART3)
  {
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOD, DE2_DIN_Pin|DE2_DOUT_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  if(hspi->Instance==SPI1)
  {
    ...
    PB5     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = PS2_CLK_Pin|PS2_DATA_Pin|PS2_CMD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PB5     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, PS2_CLK_Pin|PS2_DATA_Pin|PS2_CMD_Pin);
